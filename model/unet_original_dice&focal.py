...
train_set = make_dataset(x_train_scaled,y_train,epochs=30 ,batch_size=10)
...
def dice_plus_focal(y_true, y_pred):
    loss_1 = dice_coef_loss(y_true, y_pred)
    loss_2 = binary_focal_loss_fixed(y_true, y_pred)
